...
description: "Part 1 of building a Chip-8 emulator in Rust: exploring the architecture of Chip-8, designing data structures for registers, memory, display, stack, timers, and keypad."
tags:
    - rust
    - chip-8
    - emulator
